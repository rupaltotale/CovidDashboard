...
import { Button, Divider, Paper, Typography, InputLabel, Select, MenuItem } from '@material-ui/core';
...
const HomePage: React.FC = () => {
    ...
    const [fetchedTemperatureByDate, setFetchedTemperatureByDate] = useState(initialState);
